...
/**
 * @class iGLRenderable
 * All classes which will be rendered using OpenGL must inherit this class.
 */
class iGLRenderable
{
public:
    ...
    /**
     * Get the model matrix which transforms the model from model space to world space.
    ...
    /**
     * Set the uniform buffers before calling draw to ensure the model is
