...
TEST( PixelRGB, Constructors ){
    ...
    GEO::IMG::PixelRGB_Double pixel01(0, 0.5, 1);
    ...
    GEO::IMG::PixelRGB_Double pixel02;
    ...
    GEO::IMG::PixelRGB_Double pixel03(0.25);
...
TEST( PixelGray, Constructors ){
    ...
    GEO::IMG::PixelGray_Double pixel01;
    ASSERT_NEAR( pixel01.val(), 0, 0.00001 );

    GEO::IMG::PixelGray_Double pixel02(1);
    ASSERT_NEAR( pixel02.val(), 1, 0.00001 );

    /// Create PixelGray UInt8
    GEO::IMG::PixelGray_UInt8  pixel03;
    ASSERT_EQ( pixel03.val(), 0 );

    GEO::IMG::PixelGray_UInt8  pixel04(255);
    ASSERT_EQ( pixel04.val(), 255 );
    
    /// Create PixelGray UInt12
    GEO::IMG::PixelGray_UInt12 pixel05;
    ASSERT_EQ( pixel05.val(), 0 );
    
    GEO::IMG::PixelGray_UInt12 pixel06(4095);
    ASSERT_EQ( pixel06.val(), 4095 );

    /// Create PixelGray UInt14
    GEO::IMG::PixelGray_UInt14 pixel07;
    ASSERT_EQ( pixel07.val(), 0);
    
    GEO::IMG::PixelGray_UInt14 pixel08(16383);
    ASSERT_EQ( pixel08.val(), 16383 );

    /// Create PixelGray UInt16
    GEO::IMG::PixelGray_UInt16 pixel09;
    ASSERT_EQ( pixel09.val(), 0 );

    GEO::IMG::PixelGray_UInt16 pixel10(65535);
    ASSERT_EQ( pixel10.val(), 65535);

    /// Create PixelGray UInt32
    GEO::IMG::PixelGray_UInt32 pixel11;
    ASSERT_EQ( pixel11.val(), 0 );
    
    GEO::IMG::PixelGray_UInt32 pixel12(4294967295);
...
TEST( PixelTypes, PixelCast ){
    ...
    GEO::IMG::PixelRGB_u8  testPixel01( 0, 0, 0);
    GEO::IMG::PixelGray_u8 result01 = GEO::IMG::pixel_cast<GEO::IMG::PixelGray_u8>(testPixel01);
    ASSERT_EQ( result01[0], 0 );

    // RGB_d to Grayscale uint8
    GEO::IMG::PixelRGB_d   testPixel03( 0.25, 0.5, 1);
    GEO::IMG::PixelGray_u8 result03 = GEO::IMG::pixel_cast<GEO::IMG::PixelGray_u8>(testPixel03);
    ASSERT_EQ( result03[0], 148);

    // Grayscale to RGB
    GEO::IMG::PixelGray_u8 testPixel02( 0 );
    GEO::IMG::PixelRGB_u8  result02 = GEO::IMG::pixel_cast<GEO::IMG::PixelRGB_u8>(testPixel02);
    ASSERT_EQ( result02[0], 0 );
    ASSERT_EQ( result02[1], 0 );
    ASSERT_EQ( result02[2], 0 );
    
    // Grayscale to RGB
    GEO::IMG::PixelGray_u8 testPixel04( 100 );
    GEO::IMG::PixelRGB_d   result04 = GEO::IMG::pixel_cast<GEO::IMG::PixelRGB_d>(testPixel04);
    ...
    GEO::IMG::PixelGray_u8 testPixel05(100);
    GEO::IMG::PixelGray_d  result05 = GEO::IMG::pixel_cast<GEO::IMG::PixelGray_d>(testPixel05);
    ASSERT_NEAR( result05[0], 100.0/255, 0.001 );

    /// RGB to RGB
    GEO::IMG::PixelRGB_u8 testPixel06(0, 100, 255);
    GEO::IMG::PixelRGB_d  result06 = GEO::IMG::pixel_cast<GEO::IMG::PixelRGB_d>(testPixel06);
